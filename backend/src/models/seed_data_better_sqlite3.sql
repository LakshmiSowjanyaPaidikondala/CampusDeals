...
('calculator', 'MS', 'CALC-MS', 950.00, 'Calci.jpg', 20),

-- Start transaction for optimal performance('calculator', 'ES', 'CALC-ES', 950.00, 'Calci.jpg', 25),

BEGIN TRANSACTION;('calculator', 'ES-Plus', 'CALC-ESP', 950.00, 'Calci.jpg', 15),



-- Insert Users (Buyers, Sellers, and Admin)-- ChartBox

-- Password is 'password123' hashed with bcrypt rounds=12('chartbox', 'chart holder', 'CHART-MS', 60.00, 'chart holder.jpg', 20);
...
VALUES('calculator', 'MS', 'CALC-MS', 950.00, 'Calci.jpg', 20),

-- Buyers('calculator', 'ES', 'CALC-ES', 950.00, 'Calci.jpg', 25),

('Ravi Kumar', 'ravi@example.com', '$2a$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewdBPj1fJg7zRPO6', 'buyer', '9876543210', '2nd Year', 'CSE', 'A', 'Hostel', 0.00, 0.00),('calculator', 'ES-Plus', 'CALC-ESP', 950.00, 'Calci.jpg', 15),
...
('Sneha Patel', 'sneha@example.com', '$2a$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewdBPj1fJg7zRPO6', 'buyer', '9988776655', '2nd Year', 'EEE', 'A', 'Day Scholar', 0.00, 0.00),('chartbox', 'chart holder', 'CHART-MS', 60.00, 'chart holder.jpg', 20);imized for better-sqlite3@12.2.0 with transactions and prepared statements
...
('drafter', 'premium_drafter', 'DFT-P', 400.00, 'Drafter.jpeg', 15),('Priya Singh', 'priya@example.com', '$2a$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewdBPj1fJg7zRPO6', 'seller', '9123987654', '3rd Year', 'CSE', 'C', 'Day Scholar', 500.00, 300.00),

('drafter', 'standard_drafter', 'DFT-S', 350.00, 'Drafter.jpeg', 25),('Karan Malhotra', 'karan@example.com', '$2a$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewdBPj1fJg7zRPO6', 'seller', '9876012345', '2nd Year', 'ECE', 'A', 'Hostel', 1000.00, 700.00),

('drafter', 'budget_drafter', 'DFT-B', 300.00, 'Drafter.jpeg', 30),('Neha Gupta', 'neha@example.com', '$2a$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewdBPj1fJg7zRPO6', 'seller', '9234567890', '4th Year', 'ME', 'B', 'Day Scholar', 300.00, 200.00),
...
('white_lab_coat', 'S', 'WLC-S', 230.00, 'Chemical.jpeg', 12),

('white_lab_coat', 'M', 'WLC-M', 230.00, 'Chemical.jpeg', 20),-- Admin user

('white_lab_coat', 'L', 'WLC-L', 230.00, 'Chemical.jpeg', 18),('Admin User', 'admin@campusdeals.com', '$2a$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewdBPj1fJg7zRPO6', 'admin', '9999999999', 'Admin', 'Admin', 'Admin', 'Admin', 0.00, 0.00);

('white_lab_coat', 'XL', 'WLC-XL', 230.00, 'Chemical.jpeg', 10),

('white_lab_coat', 'XXL', 'WLC-XXL', 230.00, 'Chemical.jpeg', 5),-- Insert Products

INSERT INTO products 

-- Brown Lab Coats(product_name, product_variant, product_code, product_price, product_images, quantity)

('brown_lab_coat', 'S', 'BLC-S', 230.00, 'Mechanical.jpeg', 8),VALUES

('brown_lab_coat', 'M', 'BLC-M', 230.00, 'Mechanical.jpeg', 15),-- Drafters

('brown_lab_coat', 'L', 'BLC-L', 230.00, 'Mechanical.jpeg', 12),('drafter', 'premium_drafter', 'DFT-P', 400.00, 'Drafter.jpeg', 15),

('brown_lab_coat', 'XL', 'BLC-XL', 230.00, 'Mechanical.jpeg', 7),('drafter', 'standard_drafter', 'DFT-S', 350.00, 'Drafter.jpeg', 25),

('brown_lab_coat', 'XXL', 'BLC-XXL', 230.00, 'Mechanical.jpeg', 3),('drafter', 'budget_drafter', 'DFT-B', 300.00, 'Drafter.jpeg', 30),



-- Calculators-- White Lab Coats

('calculator', 'MS', 'CALC-MS', 950.00, 'Calci.jpg', 20),('white_lab_coat', 'S', 'WLC-S', 230.00, 'Chemical.jpeg', 12),

('calculator', 'ES', 'CALC-ES', 950.00, 'Calci.jpg', 25),('white_lab_coat', 'M', 'WLC-M', 230.00, 'Chemical.jpeg', 20),

('calculator', 'ES-Plus', 'CALC-ESP', 950.00, 'Calci.jpg', 15),('white_lab_coat', 'L', 'WLC-L', 230.00, 'Chemical.jpeg', 18),

('white_lab_coat', 'XL', 'WLC-XL', 230.00, 'Chemical.jpeg', 10),

-- ChartBox('white_lab_coat', 'XXL', 'WLC-XXL', 230.00, 'Chemical.jpeg', 5),

('chartbox', 'chart holder', 'CHART-MS', 60.00, 'chart holder.jpg', 20);

-- Brown Lab Coats

-- Sample cart data (optional for testing)('brown_lab_coat', 'S', 'BLC-S', 230.00, 'Mechanical.jpeg', 8),

INSERT INTO cart (user_id, product_id, quantity) VALUES('brown_lab_coat', 'M', 'BLC-M', 230.00, 'Mechanical.jpeg', 15),

(1, 1, 1), -- Ravi Kumar buying premium drafter('brown_lab_coat', 'L', 'BLC-L', 230.00, 'Mechanical.jpeg', 12),

(2, 4, 2), -- Anjali Sharma buying 2 white lab coats (S)('brown_lab_coat', 'XL', 'BLC-XL', 230.00, 'Mechanical.jpeg', 7),

(3, 14, 1), -- Mohit Verma buying MS calculator('brown_lab_coat', 'XXL', 'BLC-XXL', 230.00, 'Mechanical.jpeg', 3),
...
-- Sample order data (optional for testing)('calculator', 'ES', 'CALC-ES', 950.00, 'Calci.jpg', 25),

INSERT INTO orders (user_id, serial_no, product_id, total_amount, payment_method, status) VALUES('calculator', 'ES-Plus', 'CALC-ESP', 950.00, 'Calci.jpg', 15);

(1, 'ORD--2024', 1, 2500.00, 'upi', 'completed'),

(2, 'ORD-002-2024', 4, 900.00, 'cash', 'pending'),-- ChartBox

(3, 'ORD-003-2024', 14, 1200.00, 'upi', 'completed'),('chartbox', 'chart holder', 'CHART-MS', 60.00, 'chart holder.jpg', 20);
