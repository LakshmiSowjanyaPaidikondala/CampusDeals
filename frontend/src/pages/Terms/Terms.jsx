          ...
          <div className="terms-section">
            ...
            <div className="terms-content">
              ...
              <ul className="terms-list">
                <li>The seller has <strong>no right to take the item back</strong>. Under any circumstances if he/she wants to take their item, they must pay a compensation of <strong>25% of the product's cost</strong>.</li>
